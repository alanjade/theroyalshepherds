...
export function OfficerCard({
  name, position, rank, photoUrl, bio, occupation,
}: { name: string; position: string; rank?: string | null; photoUrl?: string | null; bio?: string | null; occupation?: string | null }) {
  return (
    <div className="text-center">
      ...
      {occupation && <p className="text-xs text-charcoal/50">{occupation}</p>}
